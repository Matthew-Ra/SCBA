        ...
        bool collisionHorizontal() {
                if (inBetween(cen_x - 16, this->x1, this->x2)){
                        if (inBetween(cen_y + 16, this->y1, this->y2)){
                                ...
                                if ( (inBetween(cen_x + 16, this->x2, this->x2 + 8)) or (inBetween(cen_x + 16, this->x1 - 8, this->x1 + 8))){
                                return(true);
                                }
                        } else return(false);
                } else return(false);
...
void levelSetup(sceneClass scene) {
        ...
        //Scene ID, type (level/cutscene/menu), switch statement to handle each case
